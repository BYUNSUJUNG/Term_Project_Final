...
@include('bbs/jingeriaNav')
<div class="container">


        <div class="slide">
            <button class="prev" type="button"><img class="button_left" src="img/button_left.png" alt="피자" /></button>
            <ul>
                <li><img src="img/slide1.jpg" alt="피자"/></li>
                <li><img src="img/slide2.jpg" alt="피자"/></li>           
                <li><img src="img/slide3.jpg" alt="피자"/></li>
            </ul>
            <button class="next" type="button"><img class="button_right" src="img/button_right.png" alt="피자" /></button>
        </div>
        ...
        <div class="card" style="width: 23rem;">
            <a href="http://localhost/201802A/201812%EC%B4%88/menuBurgerView.php?num=40&writer=%EA%B4%80%EB%A6%AC%EC%9E%90&title=%EB%B6%88%EA%B3%A0%EA%B8%B0%EB%B2%84%EA%B1%B0&file=burger1.jpg">
                <img class="card-img-top" src="img/burger1.jpg" alt="pizza">
                <div class="card-body">
        ...
        <div class="card" style="width: 23rem;">
            <a href="http://localhost/201802A/201812%EC%B4%88/menuchickenView.php?num=32&writer=%EA%B4%80%EB%A6%AC%EC%9E%90&title=%ED%9B%84%EB%9D%BC%EC%9D%B4%EB%93%9C%EB%8B%AD%EB%8B%A4%EB%A6%AC&file=chicken1.jpg">
                <img class="card-img-top" src="img/chicken1.jpg" alt="pizza">
                <div class="card-body">
        ...
        <div class="card" style="width: 23rem;">
            <a href="http://localhost/201802A/201812%EC%B4%88/menuSideView.php?num=32&writer=%EA%B4%80%EB%A6%AC%EC%9E%90&title=%ED%9C%A0%EB%9E%A9&file=side1.jpg">
                <img class="card-img-top" src="img/side1.jpg" alt="pizza">
                <div class="card-body">
