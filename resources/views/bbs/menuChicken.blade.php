    ...
    <div class="row">
        <div class="col-xl-9 mx-auto">
            <div class="cta-inner text-center rounded">
                ...
                <span class="section-heading-lower">Chicken</span>
                </h2>

                <form action="{{('/menuChickenSearch')}}" method="post" role="search">
                    {{ csrf_field() }}
