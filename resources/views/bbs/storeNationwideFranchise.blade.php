    ...
    <div class="row">
        <div class="col-xl-9 mx-auto">
            <div class="cta-inner text-center rounded">
                ...
                <span class="section-heading-upper">store</span>
                <span class="section-heading-lower">NationwideFranchise</span>
                </h2>
                
                <form action="{{('/storeNationwideFranchiseSearch')}}" method="post" role="search">
                    {{ csrf_field() }}
            ...
            <div class="row">
                ...
                <div class="col-lg-3 col-md-4 col-xs-6 thumb" style="background-color:black; margin-top:10px; margin-left:50px; padding:5px;">
                    <a class="thumbnail" href="storeNationwideFranchiseView/{{$stores->id}}">
