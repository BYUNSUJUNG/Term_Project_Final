    ...
    <div class="row">
        <div class="col-xl-9 mx-auto">
            <div class="cta-inner text-center rounded">
                ...
                <span class="section-heading-lower">AdvertisingSchedule</span>
                </h2>
                <form action="{{('/customerAdvertisingScheduleSearch')}}" method="post" role="search">
                    {{ csrf_field() }}
            ...
            <table class="table table-hover" style="background-color:white; margin-top:20px;">
				...
				@foreach($customer as $customers)
					<tr>
						<td>{{$customers->id}}</td>
						<td>
                            <a href="customerAdvertisingScheduleView/{{$customers->id}}">
								{{$customers->title}}						
							</a>		
						</td>
